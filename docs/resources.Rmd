---
title: <span class='ex-title'>Resources</span>
date: March 12, 2019
output: 
  html_document: 
...
- [Introduction to R](https://cengel.github.io/R-intro/), Claudia Engel
...
- [DataCamp](https://www.datacamp.com/), DataCamp ($, some free)

## Spatial Data in R Tutorials

- [Using Spatial Data with R](https://cengel.github.io/R-spatial/), Claudia Engel
...
- [Applied Spatial Data Analysis with R](http://www.asdar-book.org/), Roger S. Bivand, Edzer Pebesma and V. G&#243;mez-Rubio. UseR! Series, Springer

- [Geocomputation with R](http://robinlovelace.net/geocompr/), Robin Lovelace, Jakub Nowosad, and Jannes Muenchow

## R Package Reviews

- <p>[Analysis of Spatial Data](https://cran.r-project.org/web/views/Spatial.html), CRAN Task View</p>
...
- <p>[Webinars](https://www.rstudio.com/resources/webinars/), RStudio</p>

## R and ArcGIS

- [R-ArcGIS Bridge Tutorial](https://www.youtube.com/watch?v=9lpPuCmVmxc), ESRI

- [arcgisbinding R Package](https://r-arcgis.github.io/assets/arcgisbinding-vignette.html), ESRI
